package com.example.android.myapplication.Maps;
...
//         Obtain the SupportMapFragment and get notified when the map is ready to be used.
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Button btnMonuments = (Button) findViewById(R.id.btnMonuments);
        btnMonuments.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("onClick", "Button is Clicked");
                mMap.clear();
                String url = getUrl(latitude, longitude, Monuments);
                Object[] DataTransfer = new Object[2];
                DataTransfer[0] = mMap;
                DataTransfer[1] = url;
                Log.d("onClick", url);
                GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(MapsActivity.this,"Nearby Monuments", Toast.LENGTH_LONG).show();
            }
        });
